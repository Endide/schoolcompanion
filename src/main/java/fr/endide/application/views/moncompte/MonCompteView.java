...
import fr.endide.application.data.entity.SamplePerson;
import fr.endide.application.data.service.SamplePersonService;
...
public class MonCompteView extends Div {
    ...
    public MonCompteView(SamplePersonService personService) {
